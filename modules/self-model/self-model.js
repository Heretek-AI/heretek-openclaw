 ...
 * 
 * This module provides meta-cognition capabilities, enabling the collective
 * to understand its own capabilities, limitations, and cognitive state.
 * 
 * Maintains:
 ...
 *   const model = new SelfModel('my-agent');
...
// Configuration
const STATE_FILE = process.env.SELF_MODEL_FILE || 
    path.join(__dirname, 'self-model-state.json');
